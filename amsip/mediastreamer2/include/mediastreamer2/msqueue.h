...
#define mblk_set_video_width(m,width) (m)->reserved3=(width);
#define mblk_get_video_width(m)    ((m)->reserved3)
#define mblk_set_video_height(m,height) (m)->reserved4=(height);
#define mblk_get_video_height(m)    ((m)->reserved4)
#define mblk_set_video_format(m,format) (m)->reserved5=(format);
#define mblk_get_video_format(m)    ((m)->reserved5)
