...
static	LPSHARED_DATA	lpSharedData = NULL;
				   ...
				   )  
{
    ...
    { 
        ...
        case DLL_THREAD_ATTACH:
			...
			if (lpSharedData != NULL)
			{
				OutputDebugString("--> dll_entry.c - oRTP.dll - DLL_THREAD_ATTACH\n");
        ...
        case DLL_PROCESS_DETACH:
			...
			if (lpSharedData != NULL)
			{			
				OutputDebugString("--> dll_entry.c - oRTP.dll - DLL_PROCESS_DETACH\n");
				lpSharedData->m_nReference--;
